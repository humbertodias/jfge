...
@Component(
    modules = {
      EngineModule.class,
      LibGdxEngineModule.class,
      LibGdxGraphicsModule.class,
      ...
      MortalKombat2CollisionModule.class,
...
public interface JfgeLibGdxComponent {

  Engine engine();

  LibGdxGraphicsProvider libGdxGraphicsProvider();

  LibGdxKeyboardController1 libGdxKeyboardController1();

  LibGdxKeyboardController2 libGdxKeyboardController2();
