...
public class J2SeRectangle extends Rectangle implements org.jfge.spi.graphics.Rectangle {
  ...
  public org.jfge.spi.graphics.Rectangle rectIntersection(org.jfge.spi.graphics.Rectangle r) {
    ...
    if (!(r instanceof J2SeRectangle)) return null;
  ...
  public boolean rectIntersects(org.jfge.spi.graphics.Rectangle r) {
    ...
    if (!(r instanceof J2SeRectangle)) return false;
