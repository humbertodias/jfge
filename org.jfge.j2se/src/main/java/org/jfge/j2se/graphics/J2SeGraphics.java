...
public final class J2SeGraphics extends Graphics implements org.jfge.spi.graphics.Graphics {
  ...
  public void setGraphicsColor(org.jfge.spi.graphics.Color color) {
    ...
    if (!(color instanceof J2SeColor)) return;
  ...
  public void drawImage(int x, int y, org.jfge.spi.graphics.Image image) {
    ...
    if (!(image instanceof J2SeImage)) return;
