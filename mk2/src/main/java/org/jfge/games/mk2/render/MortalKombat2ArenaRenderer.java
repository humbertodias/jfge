...
public class MortalKombat2ArenaRenderer implements ArenaRenderer {
  ...
  public MortalKombat2ArenaRenderer(GraphicsFactory graphicsFactory) throws IOException {
    ...
    lifeBarTextFont =
        graphicsFactory.createFont(
            org.jfge.spi.graphics.Font.DEFAULT, org.jfge.spi.graphics.Font.BOLD, 12);
    textFont =
        graphicsFactory.createFont(
            org.jfge.spi.graphics.Font.DEFAULT, org.jfge.spi.graphics.Font.BOLD, 18);
    clockFont =
        graphicsFactory.createFont(
            org.jfge.spi.graphics.Font.DEFAULT, org.jfge.spi.graphics.Font.BOLD, 20);
  }
  ...
  public void drawLifebar(
      Graphics g, String name, int health, Image portrait, int wins, int align) {
    if (align == ArenaRenderer.ALIGN_RIGHT) {
      ...
      g.drawFillRectangle(
          440 - lifebar.getWidth() + 2,
          23,
          (int) ((lifebar.getWidth() - 6) * (100 - health) / 100.0),
          lifebar.getHeight() - 6);
