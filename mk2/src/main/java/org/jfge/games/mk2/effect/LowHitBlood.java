...
public final class LowHitBlood implements Provider<CollisionEffect> {
   ...
   */
  @Inject
  public LowHitBlood(GraphicsFactory graphicsFactory, CollisionEffectFactory collisionEffectFactory) {
  ...
  public CollisionEffect get() {
    if (this.images == null) {
      ...
      try {
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/low_hit_blood_1.png"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/low_hit_blood_2.png"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/low_hit_blood_3.png"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/low_hit_blood_4.png"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/low_hit_blood_5.png"));
      } catch (IOException e) {
        e.printStackTrace();
      }
    }
    return this.collisionEffectFactory.create(images, 0.3, 0.7);
  }
}
