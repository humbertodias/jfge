...
public final class FighterFactoryImpl implements FighterFactory {
   ...
   */
  @Inject
  public FighterFactoryImpl(
      Provider<InputQueue> inputQueueProvider,
      Provider<SpriteRenderer> spriteRendererProvider,
      @Named("engine.width") int engineWidth,
      @Named("engine.height") int engineHeight) {
  ...
  public Fighter createFighter(
      ...
      String endState,
      String victoryState) {
    return new FighterImpl(
        name,
        portrait,
        spriteRendererProvider.get(),
        inputQueueProvider.get(),
        states,
        startState,
        endState,
        ENGINE_WIDTH,
   ...
   */
  @Override
  public FighterState createFighterState(
      String name,
      int damage,
      List<Image> images,
      int ticks,
