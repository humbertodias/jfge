...
public final class RectangleCollisionStrategy implements CollisionDetectionStrategy {
  ...
  public boolean intersect(Sprite sprite, Sprite colSprite) {
    org.jfge.spi.graphics.Rectangle spriteRect =
        graphicsFactory.createRectangle(
            sprite.getDirection() == Sprite.LEFT
    ...
    org.jfge.spi.graphics.Rectangle colSpriteRect =
        graphicsFactory.createRectangle(
            colSprite.getDirection() == Sprite.LEFT
                ? colSprite.getX() - colSprite.getWidth()
                : colSprite.getX(),
            colSprite.getY() - colSprite.getHeight(),
            colSprite.getWidth(),
            colSprite.getHeight());
