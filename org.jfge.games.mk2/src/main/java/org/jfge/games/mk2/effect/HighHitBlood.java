...
public final class HighHitBlood implements Provider<CollisionEffect> {
  ...
  public CollisionEffect get() {
    if (this.images == null) {
      ...
      try {
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_1.gif"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_2.gif"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_3.gif"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_4.gif"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_5.gif"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_6.gif"));
        this.images.add(
            graphicsFactory.createImage("/org/jfge/games/mk2/effect/images/high_hit_blood_7.gif"));
      } catch (IOException e) {
        e.printStackTrace();
      }
    }
