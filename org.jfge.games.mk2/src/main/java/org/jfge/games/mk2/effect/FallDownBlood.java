...
public final class FallDownBlood implements Provider<CollisionEffect> {
  ...
  public CollisionEffect get() {
    if (images == null) {
      ...
      try {
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_1.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_2.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_3.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_4.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_5.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_6.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_7.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_8.gif"));
        this.images.add(
            graphicsFactory.createImage(
                "/org/jfge/games/mk2/effect/images/uppercut_hit_blood_9.gif"));
      } catch (IOException e) {
        e.printStackTrace();
      }
    }
