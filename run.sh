...
case "$choice" in
  1)
    JAR=sf2.jar
    cp org.jfge.games.sf2/target/sf2-0.0.1-SNAPSHOT.jar $JAR
    ;;
  2)
    JAR=mk2.jar
    cp org.jfge.games.mk2/target/mk2-0.0.1-SNAPSHOT.jar $JAR
    ;;
  3)
    JAR=sfvsmk2.jar
    cp org.jfge.games.sfvsmk2/target/sfvsmk2-0.0.1-SNAPSHOT.jar $JAR
    ;;
  *)
